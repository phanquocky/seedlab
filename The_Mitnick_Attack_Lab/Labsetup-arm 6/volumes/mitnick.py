...
def spoofing_SYNPacket():
	...
	ip = IP(src="10.9.0.6", dst="10.9.0.5") #src is trusted server and dst is victim
...
###### note #####
# should `su seed` to change the user to seed
# should add .rhosts file to the /home/seed directory `touch .rhosts`
# should add the trusted server ip address to the .rhosts file `echo 10.9.0.6 > .rhosts`
# should change mode of the .rhosts file to 600 `chmod 644 .rhosts`
